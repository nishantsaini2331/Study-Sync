        ...
        <div className="flex justify-center">
          <div className="flex flex-wrap justify-center gap-8 max-w-6xl">
            {testimonials?.map((item, index) => (
              <div 
                key={item._id} 
                className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm flex flex-col transition-transform hover:scale-105"
              >
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4 text-left">
                    <h4 className="font-bold text-lg">{item.student.name}</h4>
                    <p className="text-blue-600">{item.course.title}</p>
                  </div>
                </div>
                
                <div className="flex-grow">
                  <p className="text-gray-700 italic mb-4 text-left leading-relaxed">
                    "{item.review || "I have learned a lot from this course."}"
                  </p>
                </div>
